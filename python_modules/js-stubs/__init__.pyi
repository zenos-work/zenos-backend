...
BackgroundFetchFailureReason = Literal[
    "",
    "aborted",
    "bad-status",
    "fetch-error",
...
CredentialMediationRequirement = Literal[
    "silent", "optional", "conditional", "required"
]

ScriptingPolicyViolationType = Literal[
    "externalScript", "inlineScript", "inlineEventHandler", "eval"
]
...
MediaKeySessionClosedReason = Literal[
    "internal-error",
...
RTCDegradationPreference = Literal[
...
ResizeObserverBoxOptions = Literal[
...
SpeechSynthesisErrorCode = Literal[
    "canceled",
    "interrupted",
    "audio-busy",
    "audio-hardware",
...
RTCStatsIceCandidatePairState = Literal[
...
RTCPeerConnectionState = Literal[
    "closed", "failed", "disconnected", "new", "connecting", "connected"
]

RTCIceConnectionState = Literal[
...
RTCRtpTransceiverDirection = Literal[
...
class ANGLE_instanced_arrays:
    ...
    def drawArraysInstancedANGLE(
        self, mode: GLenum, first: GLint, count: GLsizei, primcount: GLsizei
    ): ...
...
class SecurityPolicyViolationEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: SecurityPolicyViolationEventInit | None = {}
...
class Element(
    ...
    def focusableAreas(
        self, option: FocusableAreasOption | None = {}
    ) -> Sequence[Node]: ...
    def spatialNavigationSearch(
        self,
        dir: SpatialNavigationDirection,
        options: SpatialNavigationSearchOptions | None = {},
    ) -> Node | None: ...
    ...
    def toggleAttribute(
        self, qualifiedName: str, force: bool | None = None
    ) -> bool: ...
    ...
    def getAttributeNodeNS(
        self, namespace: str | None, localName: str
    ) -> Attr | None: ...
    ...
    def requestFullscreen(
        self, options: FullscreenOptions | None = {}
    ) -> Awaitable[None]: ...
...
class CredentialRequestOptions(
    TypedDict, TypedDict, TypedDict, TypedDict, TypedDict, TypedDict
):
...
class Blob:
    ...
    def new(
        self,
        blobParts: Sequence[BlobPart] | None = None,
        options: BlobPropertyBag | None = {},
    ) -> Blob: ...
    size: int
    type: str
    def slice(
...
class File(Blob):
    ...
    def new(
        self,
        fileBits: Sequence[BlobPart],
        fileName: USVString,
        options: FilePropertyBag | None = {},
    ) -> File: ...
    name: str
    lastModified: int
...
class IDBVersionChangeEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: IDBVersionChangeEventInit | None = {}
...
class WindowOrWorkerGlobalScope:
    ...
    crypto: Crypto
    def fetch(
        self, input: RequestInfo, init: RequestInit | None = {}
    ) -> Awaitable[Response]: ...
    ...
    def setTimeout(
        self, handler: TimerHandler, timeout: int | None = 0, *arguments: Any
    ) -> int: ...
    ...
    def createImageBitmap(
        self, image: ImageBitmapSource, options: ImageBitmapOptions | None = {}
    ) -> Awaitable[ImageBitmap]: ...
    @overload
    def createImageBitmap(
        self,
        ...
        sw: int,
        sh: int,
        options: ImageBitmapOptions | None = {},
    ) -> Awaitable[ImageBitmap]: ...
    def structuredClone(
        self, value: Any, options: StructuredSerializeOptions | None = {}
    ) -> Any: ...
    scheduler: Scheduler
    caches: CacheStorage
...
class IDBDatabase(EventTarget):
    ...
    def transaction(
        self,
        storeNames: str | Sequence[str],
        mode: IDBTransactionMode | None = "readonly",
        options: IDBTransactionOptions | None = {},
    ) -> IDBTransaction: ...
    def close(self): ...
    def createObjectStore(
        self, name: str, options: IDBObjectStoreParameters | None = {}
    ) -> IDBObjectStore: ...
...
class IDBObjectStore:
    ...
    def getAll(
        self, query: Any | None = None, count: int | None = None
    ) -> IDBRequest: ...
    def getAllKeys(
        self, query: Any | None = None, count: int | None = None
    ) -> IDBRequest: ...
    ...
    def openCursor(
        self, query: Any | None = None, direction: IDBCursorDirection | None = "next"
    ) -> IDBRequest: ...
    def openKeyCursor(
        self, query: Any | None = None, direction: IDBCursorDirection | None = "next"
    ) -> IDBRequest: ...
    ...
    def createIndex(
        ...
        options: IDBIndexParameters | None = {},
    ) -> IDBIndex: ...
...
class OES_draw_buffers_indexed:
    ...
    def blendEquationSeparateiOES(
        self, buf: GLuint, modeRGB: GLenum, modeAlpha: GLenum
    ): ...
    ...
    def colorMaskiOES(
        self, buf: GLuint, r: GLboolean, g: GLboolean, b: GLboolean, a: GLboolean
    ): ...
...
class OES_vertex_array_object:
    ...
    def isVertexArrayOES(
        self, arrayObject: WebGLVertexArrayObjectOES | None
    ) -> GLboolean: ...
...
class Document(
    ...
    def startViewTransition(
        self, callback: UpdateCallback | None = None
    ) -> ViewTransition: ...
    ...
    def getElementsByClassName(self, classNames: str) -> HTMLCollection: ...
    def createElement(
        self, localName: str, options: str | ElementCreationOptions | None = {}
    ) -> Element: ...
    def createElementNS(
        self,
        namespace: str | None,
        qualifiedName: str,
        options: str | ElementCreationOptions | None = {},
    ) -> Element: ...
    ...
    def createNodeIterator(
        self,
        root: Node,
        whatToShow: int | None = 0xFFFFFFFF,
    ...
    def measureText(
        self, text: str, styleMap: StylePropertyMapReadOnly
    ) -> FontMetrics: ...
    ...
    @overload
    def open(
        self, unused1: str | None = None, unused2: str | None = None
    ) -> Document: ...
    @overload
    ...
    designMode: str
    def execCommand(
        self, commandId: str, showUI: bool | None = false, value: str | None = ""
    ) -> bool: ...
...
class SVGSVGElement(SVGGraphicsElement, SVGFitToViewBox, WindowEventHandlers):
    ...
    def getIntersectionList(
        self, rect: DOMRectReadOnly, referenceElement: SVGElement | None
    ) -> NodeList: ...
    def getEnclosureList(
        self, rect: DOMRectReadOnly, referenceElement: SVGElement | None
    ) -> NodeList: ...
    ...
    def createSVGTransformFromMatrix(
        self, matrix: DOMMatrix2DInit | None = {}
    ) -> SVGTransform: ...
...
class ShadowAnimation(Animation):
    @classmethod
    def new(
        self, source: Animation, newTarget: Element | CSSPseudoElement
    ) -> ShadowAnimation: ...
...
class WEBGL_multi_draw:
    def multiDrawArraysWEBGL(
        self,
        mode: GLenum,
        firstsList: Int32Array | Sequence[GLint],
        firstsOffset: GLuint,
        countsList: Int32Array | Sequence[GLsizei],
        countsOffset: GLuint,
        drawcount: GLsizei,
    ): ...
    def multiDrawElementsWEBGL(
        ...
        countsOffset: GLuint,
        type: GLenum,
        offsetsList: Int32Array | Sequence[GLsizei],
    ...
    def multiDrawArraysInstancedWEBGL(
        ...
        countsList: Int32Array | Sequence[GLsizei],
        countsOffset: GLuint,
        instanceCountsList: Int32Array | Sequence[GLsizei],
...
class WEBGL_multi_draw_instanced_base_vertex_base_instance:
    def multiDrawArraysInstancedBaseInstanceWEBGL(
        ...
        instanceCountsList: Int32Array | Sequence[GLsizei],
        instanceCountsOffset: GLuint,
        baseInstancesList: Uint32Array | Sequence[GLuint],
        baseInstancesOffset: GLuint,
        drawcount: GLsizei,
    ): ...
    def multiDrawElementsInstancedBaseVertexBaseInstanceWEBGL(
        ...
        instanceCountsList: Int32Array | Sequence[GLsizei],
        instanceCountsOffset: GLuint,
        baseVerticesList: Int32Array | Sequence[GLint],
        baseVerticesOffset: GLuint,
        baseInstancesList: Uint32Array | Sequence[GLuint],
        baseInstancesOffset: GLuint,
        drawcount: GLsizei,
    ): ...
...
class SubtleCrypto:
    def encrypt(
        self, algorithm: AlgorithmIdentifier, key: CryptoKey, data: BufferSource
    ) -> Awaitable[Any]: ...
    def decrypt(
        self, algorithm: AlgorithmIdentifier, key: CryptoKey, data: BufferSource
    ) -> Awaitable[Any]: ...
    ...
    def digest(
        self, algorithm: AlgorithmIdentifier, data: BufferSource
    ) -> Awaitable[Any]: ...
    def generateKey(
        self,
        algorithm: AlgorithmIdentifier,
        extractable: bool,
        keyUsages: Sequence[KeyUsage],
    ) -> Awaitable[Any]: ...
    def deriveKey(
        self,
        algorithm: AlgorithmIdentifier,
    ...
    def deriveBits(
        self, algorithm: AlgorithmIdentifier, baseKey: CryptoKey, length: int
...
class LinearAccelerationSensor(Accelerometer):
    @classmethod
    def new(
        self, options: AccelerometerSensorOptions | None = {}
...
class XRFrame:
    def createAnchor(
        self, pose: XRRigidTransform, space: XRSpace
    ) -> Awaitable[XRAnchor]: ...
    trackedAnchors: XRAnchorSet
    def getDepthInformation(self, view: XRView) -> XRCPUDepthInformation | None: ...
    def getJointPose(
        self, joint: XRJointSpace, baseSpace: XRSpace
    ) -> XRJointPose | None: ...
    def fillJointRadii(
        self, jointSpaces: Sequence[XRJointSpace], radii: Float32Array
    ) -> bool: ...
    def fillPoses(
        self, spaces: Sequence[XRSpace], baseSpace: XRSpace, transforms: Float32Array
    ) -> bool: ...
    def getHitTestResults(
        self, hitTestSource: XRHitTestSource
    ) -> Sequence[XRHitTestResult]: ...
    def getHitTestResultsForTransientInput(
        self, hitTestSource: XRTransientInputHitTestSource
    ...
    def getViewerPose(
        self, referenceSpace: XRReferenceSpace
    ) -> XRViewerPose | None: ...
...
class XRSession(EventTarget):
    ...
    def requestHitTestSource(
        self, options: XRHitTestOptionsInit
    ) -> Awaitable[XRHitTestSource]: ...
    def requestHitTestSourceForTransientInput(
        self, options: XRTransientInputHitTestOptionsInit
    ) -> Awaitable[XRTransientInputHitTestSource]: ...
    def requestLightProbe(
        self, options: XRLightProbeInit | None = {}
    ) -> Awaitable[XRLightProbe]: ...
    ...
    def requestReferenceSpace(
        self, type: XRReferenceSpaceType
    ) -> Awaitable[XRReferenceSpace]: ...
...
class HTMLAnchorElement(
    HTMLElement, HTMLAttributionSrcElementUtils, HTMLHyperlinkElementUtils
):
    @classmethod
...
class HTMLMediaElement(HTMLElement):
    ...
    def addTextTrack(
        self, kind: TextTrackKind, label: str | None = "", language: str | None = ""
    ) -> TextTrack: ...
...
class MediaDevices(EventTarget):
    def selectAudioOutput(
        self, options: AudioOutputOptions | None = {}
    ) -> Awaitable[MediaDeviceInfo]: ...
    ...
    def getUserMedia(
        self, constraints: MediaStreamConstraints | None = {}
    ) -> Awaitable[MediaStream]: ...
    def getViewportMedia(
        self, constraints: ViewportMediaStreamConstraints | None = {}
    ) -> Awaitable[MediaStream]: ...
    def getDisplayMedia(
        self, options: DisplayMediaStreamOptions | None = {}
    ) -> Awaitable[MediaStream]: ...
...
class Navigator(
    ...
    def requestMediaKeySystemAccess(
        self,
        keySystem: str,
        supportedConfigurations: Sequence[MediaKeySystemConfiguration],
    ) -> Awaitable[MediaKeySystemAccess]: ...
    ...
    hid: HID
    def requestMIDIAccess(
        self, options: MIDIOptions | None = {}
    ) -> Awaitable[MIDIAccess]: ...
    usb: USB
    xr: XRSystem
...
class ServiceWorkerRegistration(EventTarget):
    ...
    def showNotification(
        self, title: str, options: NotificationOptions | None = {}
    ) -> Awaitable[None]: ...
    def getNotifications(
        self, filter: GetNotificationOptions | None = {}
    ) -> Awaitable[Sequence[Notification]]: ...
...
class BackgroundFetchManager:
    def fetch(
        self,
        id: str,
        requests: RequestInfo | Sequence[RequestInfo],
        options: BackgroundFetchOptions | None = {},
    ) -> Awaitable[BackgroundFetchRegistration]: ...
...
class BackgroundFetchRegistration(EventTarget):
    ...
    def match(
        self, request: RequestInfo, options: CacheQueryOptions | None = {}
    ) -> Awaitable[BackgroundFetchRecord]: ...
    def matchAll(
        self, request: RequestInfo | None = None, options: CacheQueryOptions | None = {}
    ) -> Awaitable[Sequence[BackgroundFetchRecord]]: ...
...
class BackgroundFetchEvent(ExtendableEvent):
    @classmethod
    def new(
        self, type: str, init: BackgroundFetchEventInit
...
class BackgroundFetchUpdateUIEvent(BackgroundFetchEvent):
    ...
    def updateUI(
        self, options: BackgroundFetchUIOptions | None = {}
    ) -> Awaitable[None]: ...
...
class MediaStreamTrack(EventTarget):
    ...
    def applyConstraints(
        self, constraints: MediaTrackConstraints | None = {}
    ) -> Awaitable[None]: ...
    contentHint: str
    isolated: bool
...
class ClipboardEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: ClipboardEventInit | None = {}
    ) -> ClipboardEvent: ...
...
class ClipboardItem:
    @classmethod
    def new(
        self, items: ClipboardItemData, options: ClipboardItemOptions | None = {}
    ) -> ClipboardItem: ...
...
class Window(
    ...
    def getComputedStyle(
        self, elt: Element, pseudoElt: CSSOMString | None = None
    ) -> CSSStyleDeclaration: ...
    def getDigitalGoodsService(
        self, serviceProvider: str
    ) -> Awaitable[DigitalGoodsService]: ...
    event: Event | None
    def showOpenFilePicker(
        self, options: OpenFilePickerOptions | None = {}
    ) -> Awaitable[Sequence[FileSystemFileHandle]]: ...
    def showSaveFilePicker(
        self, options: SaveFilePickerOptions | None = {}
    ) -> Awaitable[FileSystemFileHandle]: ...
    def showDirectoryPicker(
        self, options: DirectoryPickerOptions | None = {}
    ) -> Awaitable[FileSystemDirectoryHandle]: ...
    window: WindowProxy
    self: WindowProxy
    document: Document
    name: str
    ...
    def prompt(
        self, message: str | None = "", default: str | None = ""
    ) -> str | None: ...
    def print(self): ...
    @overload
    def postMessage(
        ...
        transfer: Sequence[object] | None = [],
    ): ...
    @overload
    def postMessage(
        self, message: Any, options: WindowPostMessageOptions | None = {}
    ): ...
    def captureEvents(self): ...
    def releaseEvents(self): ...
    external: External
    def queryLocalFonts(
        self, options: QueryOptions | None = {}
    ) -> Awaitable[Sequence[FontData]]: ...
    ...
    def requestIdleCallback(
        self, callback: IdleRequestCallback, options: IdleRequestOptions | None = {}
    ) -> int: ...
...
class PressureObserver:
    ...
    def new(
        ...
        options: PressureObserverOptions | None = {},
    ) -> PressureObserver: ...
...
class ConsoleNamespace:
    ...
    def table(
        self, tabularData: Any | None = None, properties: Sequence[str] | None = None
    ): ...
...
class ContactsManager:
    ...
    def select(
        ...
        options: ContactsSelectOptions | None = {},
    ) -> Awaitable[Sequence[ContactInfo]]: ...
...
class CookieStore(EventTarget):
    ...
    @overload
    def get(
        self, options: CookieStoreGetOptions | None = {}
    ) -> Awaitable[CookieListItem | None]: ...
    @overload
    def getAll(self, name: USVString) -> Awaitable[CookieList]: ...
    @overload
    def getAll(
        self, options: CookieStoreGetOptions | None = {}
    ) -> Awaitable[CookieList]: ...
    @overload
...
class CookieStoreManager:
    def subscribe(
        self, subscriptions: Sequence[CookieStoreGetOptions]
    ) -> Awaitable[None]: ...
...
class CookieChangeEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: CookieChangeEventInit | None = {}
    ) -> CookieChangeEvent: ...
...
class ExtendableCookieChangeEvent(ExtendableEvent):
    @classmethod
    def new(
        self, type: str, eventInitDict: ExtendableCookieChangeEventInit | None = {}
...
class CredentialsContainer:
    def get(
        self, options: CredentialRequestOptions | None = {}
    ) -> Awaitable[Credential | None]: ...
    def store(self, credential: Credential) -> Awaitable[Credential]: ...
    def create(
        self, options: CredentialCreationOptions | None = {}
    ) -> Awaitable[Credential | None]: ...
...
class AnimationWorkletGlobalScope(WorkletGlobalScope):
    def registerAnimator(
        self, name: str, animatorCtor: AnimatorInstanceConstructor
    ): ...
...
class WorkletAnimation(Animation):
    ...
    def new(
        self,
        animatorName: str,
        effects: AnimationEffect | Sequence[AnimationEffect] | None = None,
...
class AnimationEvent(Event):
    @classmethod
    def new(
        self, type: CSSOMString, animationEventInitDict: AnimationEventInit | None = {}
    ) -> AnimationEvent: ...
    animationName: CSSOMString
    elapsedTime: float
...
class CssNamespace:
    ...
    def parseStylesheet(
        self, css: CSSStringSource, options: CSSParserOptions | None = {}
    ) -> Awaitable[Sequence[CSSParserRule]]: ...
    def parseRuleList(
        self, css: CSSStringSource, options: CSSParserOptions | None = {}
    ) -> Awaitable[Sequence[CSSParserRule]]: ...
    def parseRule(
        self, css: CSSStringSource, options: CSSParserOptions | None = {}
    ) -> Awaitable[CSSParserRule]: ...
    def parseDeclarationList(
        self, css: CSSStringSource, options: CSSParserOptions | None = {}
    ) -> Awaitable[Sequence[CSSParserRule]]: ...
    def parseDeclaration(
        self, css: str, options: CSSParserOptions | None = {}
...
class ContentVisibilityAutoStateChangedEvent(Event):
    ...
    def new(
        self,
        type: str,
        eventInitDict: ContentVisibilityAutoStateChangedEventInit | None = {},
...
class FontFace:
    ...
    def new(
        self,
        family: CSSOMString,
        source: CSSOMString | BinaryData,
        descriptors: FontFaceDescriptors | None = {},
    ) -> FontFace: ...
    family: CSSOMString
    style: CSSOMString
    weight: CSSOMString
...
class FontFaceSetLoadEvent(Event):
    @classmethod
    def new(
        self, type: CSSOMString, eventInitDict: FontFaceSetLoadEventInit | None = {}
...
class FontFaceSet(EventTarget):
    ...
    def load(
        self, font: CSSOMString, text: CSSOMString | None = " "
    ) -> Awaitable[Sequence[FontFace]]: ...
...
class LayoutChild:
    ...
    def layoutNextFragment(
        self, constraints: LayoutConstraintsOptions, breakToken: ChildBreakToken
    ) -> Awaitable[LayoutFragment]: ...
...
class NavigationEvent(UIEvent):
    @classmethod
    def new(
        self, type: str, eventInitDict: NavigationEventInit | None = {}
    ) -> NavigationEvent: ...
    dir: SpatialNavigationDirection
...
class CSSParserAtRule(CSSParserRule):
    ...
    def new(
        self,
        name: str,
        prelude: Sequence[CSSToken],
        body: Sequence[CSSParserRule] | None = None,
    ) -> CSSParserAtRule: ...
    name: str
...
class CSSParserQualifiedRule(CSSParserRule):
    @classmethod
    def new(
        self, prelude: Sequence[CSSToken], body: Sequence[CSSParserRule] | None = None
...
class CSSParserDeclaration(CSSParserRule):
    @classmethod
    def new(
        self, name: str, body: Sequence[CSSParserRule] | None = None
    ) -> CSSParserDeclaration: ...
    name: str
...
class CSSParserFunction(CSSParserValue):
    @classmethod
    def new(
        self, name: str, args: Sequence[Sequence[CSSParserValue]]
    ) -> CSSParserFunction: ...
    name: str
...
class TransitionEvent(Event):
    ...
    def new(
        self,
        type: CSSOMString,
        transitionEventInitDict: TransitionEventInit | None = {},
    ) -> TransitionEvent: ...
...
class CSSVariableReferenceValue:
    @classmethod
    def new(
        self, variable: USVString, fallback: CSSUnparsedValue | None = None
...
class CSSMathClamp(CSSMathValue):
    @classmethod
    def new(
        self, lower: CSSNumberish, value: CSSNumberish, upper: CSSNumberish
    ) -> CSSMathClamp: ...
...
class CSSTranslate(CSSTransformComponent):
    @classmethod
    def new(
        self, x: CSSNumericValue, y: CSSNumericValue, z: CSSNumericValue | None = None
    ) -> CSSTranslate: ...
    x: CSSNumericValue
    y: CSSNumericValue
    z: CSSNumericValue
...
class CSSRotate(CSSTransformComponent):
    ...
    @classmethod
    def new(
        self, x: CSSNumberish, y: CSSNumberish, z: CSSNumberish, angle: CSSNumericValue
    ) -> CSSRotate: ...
    x: CSSNumberish
    y: CSSNumberish
    z: CSSNumberish
...
class CSSScale(CSSTransformComponent):
    @classmethod
    def new(
        self, x: CSSNumberish, y: CSSNumberish, z: CSSNumberish | None = None
    ) -> CSSScale: ...
    x: CSSNumberish
    y: CSSNumberish
    z: CSSNumberish
...
class CSSMatrixComponent(CSSTransformComponent):
    @classmethod
    def new(
        self, matrix: DOMMatrixReadOnly, options: CSSMatrixComponentOptions | None = {}
    ) -> CSSMatrixComponent: ...
    matrix: DOMMatrix
...
class MediaQueryListEvent(Event):
    @classmethod
    def new(
        self, type: CSSOMString, eventInitDict: MediaQueryListEventInit | None = {}
    ) -> MediaQueryListEvent: ...
    media: CSSOMString
    matches: bool
...
class MouseEvent(UIEvent):
    @classmethod
    def new(
        self, type: str, eventInitDict: MouseEventInit | None = {}
    ) -> MouseEvent: ...
    pageX: float
    pageY: float
    x: float
    ...
    def initMouseEvent(
        self,
        typeArg: str,
        bubblesArg: bool | None = false,
        cancelableArg: bool | None = false,
        viewArg: Window | None = None,
        detailArg: int | None = 0,
        screenXArg: int | None = 0,
        screenYArg: int | None = 0,
        clientXArg: int | None = 0,
        clientYArg: int | None = 0,
        ctrlKeyArg: bool | None = false,
        altKeyArg: bool | None = false,
        shiftKeyArg: bool | None = false,
        metaKeyArg: bool | None = false,
        buttonArg: short | None = 0,
...
class GeometryUtils:
    ...
    def convertQuadFromNode(
        ...
        quad: DOMQuadInit,
        from_: GeometryNode,
        options: ConvertCoordinateOptions | None = {},
    ) -> DOMQuad: ...
...
class CSSStyleSheet(StyleSheet):
    ...
    def addRule(
        self,
        selector: str | None = "undefined",
        style: str | None = "undefined",
        index: int | None = None,
    ) -> int: ...
...
class MathMLElement(
    Element, ElementCSSInlineStyle, GlobalEventHandlers, HTMLOrSVGElement
): ...
...
class ElementInternals(ARIAMixin):
    ...
    def setFormValue(
        self,
        value: File | USVString | FormData | None,
        state: File | USVString | FormData | None = None,
    ): ...
    form: HTMLFormElement | None
    def setValidity(
        self,
        flags: ValidityStateFlags | None = {},
...
class DataCue(TextTrackCue):
    @classmethod
    def new(
        self, startTime: float, endTime: float, value: Any, type: str | None = None
    ) -> DataCue: ...
    value: Any
    type: str
...
class DigitalGoodsService:
    def getDetails(
        self, itemIds: Sequence[str]
    ) -> Awaitable[Sequence[ItemDetails]]: ...
...
class Event:
    ...
    def initEvent(
        self, type: str, bubbles: bool | None = false, cancelable: bool | None = false
    ): ...
...
class CustomEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: CustomEventInit | None = {}
    ) -> CustomEvent: ...
    detail: Any
    def initCustomEvent(
        self,
        type: str,
        bubbles: bool | None = false,
        cancelable: bool | None = false,
...
class EventTarget:
    ...
    def addEventListener(
        ...
        options: AddEventListenerOptions | bool | None = {},
    ): ...
    def removeEventListener(
        self,
        type: str,
        callback: EventListener | None,
        options: EventListenerOptions | bool | None = {},
    ): ...
...
class XPathExpression:
    def evaluate(
        self, contextNode: Node, type: int | None = 0, result: XPathResult | None = None
    ) -> XPathResult: ...

class XPathEvaluatorBase:
    def createExpression(
        self, expression: str, resolver: XPathNSResolver | None = None
    ) -> XPathExpression: ...
    ...
    def evaluate(
        ...
        expression: str,
        contextNode: Node,
        resolver: XPathNSResolver | None = None,
        type: int | None = 0,
        result: XPathResult | None = None,
    ) -> XPathResult: ...
...
class XSLTProcessor:
    ...
    def transformToFragment(
        self, source: Node, output: Document
    ) -> DocumentFragment: ...
...
class EditContext(EventTarget):
    ...
    def updateCharacterBounds(
        self, rangeStart: int, characterBounds: Sequence[DOMRect]
    ): ...
...
class TextFormatUpdateEvent(Event):
    @classmethod
    def new(
        self, options: TextFormatUpdateEventInit | None = {}
...
class CharacterBoundsUpdateEvent(Event):
    @classmethod
    def new(
        self, options: CharacterBoundsUpdateEventInit | None = {}
...
class TextDecoder(TextDecoderCommon):
    @classmethod
    def new(
        self, label: str | None = "utf-8", options: TextDecoderOptions | None = {}
    ) -> TextDecoder: ...
    def decode(
        self, input: BufferSource | None = None, options: TextDecodeOptions | None = {}
    ) -> USVString: ...
...
class TextEncoder(TextEncoderCommon):
    ...
    def encodeInto(
        self, source: USVString, destination: Uint8Array
...
class MediaKeys:
    def createSession(
        self, sessionType: MediaKeySessionType | None = "temporary"
    ) -> MediaKeySession: ...
    def setServerCertificate(
        self, serverCertificate: BufferSource
    ) -> Awaitable[bool]: ...
...
class MediaKeySession(EventTarget):
    ...
    onmessage: EventHandler
    def generateRequest(
        self, initDataType: str, initData: BufferSource
    ) -> Awaitable[None]: ...
...
class MediaKeyMessageEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: MediaKeyMessageEventInit
...
class MediaEncryptedEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: MediaEncryptedEventInit | None = {}
    ) -> MediaEncryptedEvent: ...
    initDataType: str
...
class FileSystemDirectoryEntry(FileSystemEntry):
    ...
    def getFile(
        self,
        path: USVString | None = None,
        options: FileSystemFlags | None = {},
        successCallback: FileSystemEntryCallback | None = None,
        errorCallback: ErrorCallback | None = None,
    ): ...
    def getDirectory(
...
class FileSystemFileEntry(FileSystemEntry):
    def file(
        self, successCallback: FileCallback, errorCallback: ErrorCallback | None = None
    ): ...
...
class Performance(EventTarget):
    ...
    def mark(
        self, markName: str, markOptions: PerformanceMarkOptions | None = {}
    ) -> PerformanceMark: ...
    def clearMarks(self, markName: str | None = None): ...
    def measure(
        self,
        measureName: str,
        startOrMeasureOptions: str | PerformanceMeasureOptions | None = {},
        endMark: str | None = None,
    ) -> PerformanceMeasure: ...
...
class EyeDropper:
    ...
    def open(
        self, options: ColorSelectionOptions | None = {}
    ) -> Awaitable[ColorSelectionResult]: ...
...
class Response(Body):
    @classmethod
    def new(
        self, body: BodyInit | None = None, init: ResponseInit | None = {}
    ) -> Response: ...
    type: ResponseType
    url: USVString
    redirected: bool
...
class FileSystemHandle:
    def queryPermission(
        self, descriptor: FileSystemHandlePermissionDescriptor | None = {}
    ) -> Awaitable[PermissionState]: ...
...
class SVGFEImageElement(
    SVGElement, SVGFilterPrimitiveStandardAttributes, SVGURIReference
):
    preserveAspectRatio: SVGAnimatedPreserveAspectRatio
...
class FileSystemFileHandle(FileSystemHandle):
    ...
    def createWritable(
        self, options: FileSystemCreateWritableOptions | None = {}
    ) -> Awaitable[FileSystemWritableFileStream]: ...
...
class FileSystemDirectoryHandle(FileSystemHandle):
    def getFileHandle(
        self, name: USVString, options: FileSystemGetFileOptions | None = {}
    ) -> Awaitable[FileSystemFileHandle]: ...
    def getDirectoryHandle(
        self, name: USVString, options: FileSystemGetDirectoryOptions | None = {}
    ) -> Awaitable[FileSystemDirectoryHandle]: ...
    def removeEntry(
        self, name: USVString, options: FileSystemRemoveOptions | None = {}
    ) -> Awaitable[None]: ...
    def resolve(
        self, possibleDescendant: FileSystemHandle
    ) -> Awaitable[Sequence[USVString]]: ...
...
class FileSystemSyncAccessHandle:
    def read(
        self, buffer: BufferSource, options: FileSystemReadWriteOptions | None = {}
    ) -> int: ...
    def write(
        self, buffer: BufferSource, options: FileSystemReadWriteOptions | None = {}
    ) -> int: ...
...
class GamepadHapticActuator:
    ...
    def playEffect(
        self, type: GamepadHapticEffectType, params: GamepadEffectParameters | None = {}
    ) -> Awaitable[GamepadHapticsResult]: ...
...
class SensorErrorEvent(Event):
    @classmethod
    def new(
        self, type: str, errorEventInitDict: SensorErrorEventInit
    ) -> SensorErrorEvent: ...
    error: DOMException
...
class GeolocationSensor(Sensor):
    @classmethod
    def new(
        self, options: GeolocationSensorOptions | None = {}
    ) -> GeolocationSensor: ...
    latitude: float | None
...
class Geolocation:
    def getCurrentPosition(
        ...
        errorCallback: PositionErrorCallback | None = None,
        options: PositionOptions | None = {},
    ): ...
    def watchPosition(
        self,
        successCallback: PositionCallback,
...
class DOMQuad:
    ...
    def new(
        self,
        p1: DOMPointInit | None = {},
        p2: DOMPointInit | None = {},
        p3: DOMPointInit | None = {},
        p4: DOMPointInit | None = {},
    ) -> DOMQuad: ...
    p1: DOMPoint
    p2: DOMPoint
    p3: DOMPoint
...
class DOMMatrixReadOnly:
    ...
    isIdentity: bool
    def translate(
        self, tx: float | None = 0, ty: float | None = 0, tz: float | None = 0
    ) -> DOMMatrix: ...
    def scale(
        self,
        scaleX: float | None = 1,
        ...
        scaleZ: float | None = 1,
        originX: float | None = 0,
        originY: float | None = 0,
        originZ: float | None = 0,
    ) -> DOMMatrix: ...
    def scaleNonUniform(
        self, scaleX: float | None = 1, scaleY: float | None = 1
    ) -> DOMMatrix: ...
    def scale3d(
        self,
        scale: float | None = 1,
    ...
    def rotateFromVector(
        self, x: float | None = 0, y: float | None = 0
    ) -> DOMMatrix: ...
    def rotateAxisAngle(
        self,
        x: float | None = 0,
...
class HTMLAllCollection:
    length: int
    def item(
        self, nameOrIndex: str | None = None
    ) -> HTMLCollection | Element | None: ...
...
class HTMLOptionsCollection(HTMLCollection):
    ...
    def add(
        ...
        before: HTMLElement | int | None = None,
    ): ...
...
class TrackEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: TrackEventInit | None = {}
    ) -> TrackEvent: ...
...
class SubmitEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: SubmitEventInit | None = {}
    ) -> SubmitEvent: ...
...
class HTMLSlotElement(HTMLElement):
    ...
    name: str
    def assignedNodes(
        self, options: AssignedNodesOptions | None = {}
    ) -> Sequence[Node]: ...
    def assignedElements(
        self, options: AssignedNodesOptions | None = {}
    ) -> Sequence[Element]: ...
...
class HTMLCanvasElement(HTMLElement):
    ...
    height: int
    def getContext(
        self, contextId: str, options: Any | None = None
    ) -> RenderingContext | None: ...
    def toDataURL(
        self, type: str | None = "image/png", quality: Any | None = None
    ) -> USVString: ...
    def toBlob(
        self,
        callback: BlobCallback,
        type: str | None = "image/png",
...
class CanvasFillStrokeStyles:
    ...
    def createPattern(
        self, image: CanvasImageSource, repetition: str
    ) -> CanvasPattern | None: ...
...
class CanvasDrawPath:
    ...
    @overload
    def isPointInPath(
        self, x: float, y: float, fillRule: CanvasFillRule | None = "nonzero"
    ) -> bool: ...
    @overload
    def isPointInPath(
        self,
        ...
        x: float,
        y: float,
        fillRule: CanvasFillRule | None = "nonzero",
    ) -> bool: ...
    @overload
...
class CanvasDrawImage:
    ...
    @overload
    def drawImage(
        self, image: CanvasImageSource, dx: float, dy: float, dw: float, dh: float
    ): ...
    @overload
    def drawImage(
        self,
...
class CanvasImageData:
    @overload
    def createImageData(
        self, sw: int, sh: int, settings: ImageDataSettings | None = {}
    ) -> ImageData: ...
    @overload
    ...
    def getImageData(
        ...
        sw: int,
        sh: int,
        settings: ImageDataSettings | None = {},
    ) -> ImageData: ...
    @overload
...
class CanvasPath:
    ...
    def roundRect(
        ...
        w: float,
        h: float,
        radii: float | DOMPointInit | Sequence[float | DOMPointInit] | None = 0,
    ): ...
    def arc(
        self,
        x: float,
        ...
        startAngle: float,
        endAngle: float,
        counterclockwise: bool | None = false,
    ): ...
    def ellipse(
        self,
        x: float,
...
class OffscreenCanvas(EventTarget):
    ...
    height: int
    def getContext(
        self, contextId: OffscreenRenderingContextId, options: Any | None = None
    ) -> OffscreenRenderingContext | None: ...
    def transferToImageBitmap(self) -> ImageBitmap: ...
    def convertToBlob(
        self, options: ImageEncodeOptions | None = {}
    ) -> Awaitable[Blob]: ...
    oncontextlost: EventHandler
    oncontextrestored: EventHandler
...
class CustomElementRegistry:
    def define(
        ...
        options: ElementDefinitionOptions | None = {},
    ): ...
...
class PopStateEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: PopStateEventInit | None = {}
    ) -> PopStateEvent: ...
    state: Any
...
class HashChangeEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: HashChangeEventInit | None = {}
    ) -> HashChangeEvent: ...
    oldURL: USVString
    newURL: USVString
...
class PageTransitionEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: PageTransitionEventInit | None = {}
    ) -> PageTransitionEvent: ...
    persisted: bool
...
class ErrorEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: ErrorEventInit | None = {}
    ) -> ErrorEvent: ...
    message: str
    filename: USVString
    lineno: int
...
class PromiseRejectionEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: PromiseRejectionEventInit
...
class DOMParser:
    ...
    def parseFromString(
        self, string: str, type: DOMParserSupportedType
    ) -> Document: ...
...
class DedicatedWorkerGlobalScope(WorkerGlobalScope, AnimationFrameProvider):
    ...
    @overload
    def postMessage(
        self, message: Any, options: StructuredSerializeOptions | None = {}
    ): ...
    def close(self): ...
    onmessage: EventHandler
    onmessageerror: EventHandler
...
class MessageEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: MessageEventInit | None = {}
    ) -> MessageEvent: ...
    data: Any
    origin: USVString
    lastEventId: str
    ...
    def initMessageEvent(
        ...
        cancelable: bool | None = false,
        data: Any | None = None,
        origin: USVString | None = "",
        lastEventId: str | None = "",
        source: MessageEventSource | None = None,
        ports: Sequence[MessagePort] | None = [],
    ): ...
...
class EventSource(EventTarget):
    @classmethod
    def new(
        self, url: USVString, eventSourceInitDict: EventSourceInit | None = {}
    ) -> EventSource: ...
    url: USVString
...
class Worker(EventTarget, AbstractWorker):
    @classmethod
    def new(
        self, scriptURL: USVString, options: WorkerOptions | None = {}
    ) -> Worker: ...
    def terminate(self): ...
    @overload
    def postMessage(self, message: Any, transfer: Sequence[object]): ...
...
class SharedWorker(EventTarget, AbstractWorker):
    @classmethod
    def new(
        self, scriptURL: USVString, options: str | WorkerOptions | None = {}
    ) -> SharedWorker: ...
    port: MessagePort
...
class Worklet:
    def addModule(
        self, moduleURL: USVString, options: WorkletOptions | None = {}
    ) -> Awaitable[None]: ...
...
class StorageEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: StorageEventInit | None = {}
    ) -> StorageEvent: ...
    key: str | None
    oldValue: str | None
    newValue: str | None
...
class ImageCapture:
    ...
    def takePhoto(
        self, photoSettings: PhotoSettings | None = {}
    ) -> Awaitable[Blob]: ...
...
class Ink:
    def requestPresenter(
        self, param: InkPresenterParam | None = {}
    ) -> Awaitable[InkPresenter]: ...
...
class InputDeviceCapabilities:
    @classmethod
    def new(
        self, deviceInitDict: InputDeviceCapabilitiesInit | None = {}
...
class InputEvent(UIEvent):
    @classmethod
    def new(
        self, type: str, eventInitDict: InputEventInit | None = {}
    ) -> InputEvent: ...
    dataTransfer: DataTransfer | None
...
class IntersectionObserver:
    ...
    def new(
        ...
        options: IntersectionObserverInit | None = {},
...
class IntersectionObserverEntry:
    @classmethod
    def new(
        self, intersectionObserverEntryInit: IntersectionObserverEntryInit
...
class Scheduling:
    def isInputPending(
        self, isInputPendingOptions: IsInputPendingOptions | None = {}
    ) -> bool: ...
...
class Magnetometer(Sensor):
    @classmethod
    def new(
        self, sensorOptions: MagnetometerSensorOptions | None = {}
    ) -> Magnetometer: ...
    x: float | None
    y: float | None
    z: float | None
...
class BeforeInstallPromptEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: EventInit | None = {}
...
class MediaCapabilities:
    def decodingInfo(
        self, configuration: MediaDecodingConfiguration
    ) -> Awaitable[MediaCapabilitiesDecodingInfo]: ...
    def encodingInfo(
        self, configuration: MediaEncodingConfiguration
    ) -> Awaitable[MediaCapabilitiesEncodingInfo]: ...
...
class MediaStreamTrackEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: MediaStreamTrackEventInit
...
class OverconstrainedError(DOMException):
    @classmethod
    def new(
        self, constraint: str, message: str | None = ""
...
class MediaSession:
    ...
    def setActionHandler(
        self, action: MediaSessionAction, handler: MediaSessionActionHandler | None
    ): ...
...
class MediaRecorder(EventTarget):
    @classmethod
    def new(
        self, stream: MediaStream, options: MediaRecorderOptions | None = {}
    ) -> MediaRecorder: ...
    stream: MediaStream
    mimeType: str
...
class Navigation(EventTarget):
    ...
    canGoForward: bool
    def navigate(
        self, url: USVString, options: NavigationNavigateOptions | None = {}
    ) -> NavigationResult: ...
    def reload(
        self, options: NavigationReloadOptions | None = {}
    ) -> NavigationResult: ...
    def traverseTo(
        self, key: str, options: NavigationOptions | None = {}
    ) -> NavigationResult: ...
...
class NavigationCurrentEntryChangeEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInit: NavigationCurrentEntryChangeEventInit
...
class NotificationEvent(ExtendableEvent):
    @classmethod
    def new(
        self, type: str, eventInitDict: NotificationEventInit
    ) -> NotificationEvent: ...
...
class DeviceOrientationEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: DeviceOrientationEventInit | None = {}
...
class DeviceMotionEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: DeviceMotionEventInit | None = {}
    ) -> DeviceMotionEvent: ...
...
class AbsoluteOrientationSensor(OrientationSensor):
    @classmethod
    def new(
        self, sensorOptions: OrientationSensorOptions | None = {}
...
class PaymentManager:
    ...
    userHint: str
    def enableDelegations(
        self, delegations: Sequence[PaymentDelegation]
    ) -> Awaitable[None]: ...
...
class PaymentInstruments:
    ...
    def set(
        self, instrumentKey: str, details: PaymentInstrument
    ) -> Awaitable[None]: ...
...
class PaymentRequestEvent(ExtendableEvent):
    @classmethod
    def new(
        self, type: str, eventInitDict: PaymentRequestEventInit | None = {}
    ) -> PaymentRequestEvent: ...
    topOrigin: USVString
    ...
    def changePaymentMethod(
        self, methodName: str, methodDetails: object | None = None
    ) -> Awaitable[PaymentRequestDetailsUpdate | None]: ...
    def changeShippingAddress(
        self, shippingAddress: AddressInit | None = {}
    ) -> Awaitable[PaymentRequestDetailsUpdate | None]: ...
    def changeShippingOption(
        self, shippingOption: str
    ) -> Awaitable[PaymentRequestDetailsUpdate | None]: ...
    def respondWith(
        self, handlerResponsePromise: Awaitable[PaymentHandlerResponse]
    ): ...
...
class PaymentRequest(EventTarget):
    @classmethod
    def new(
        self, methodData: Sequence[PaymentMethodData], details: PaymentDetailsInit
    ) -> PaymentRequest: ...
    def show(
        self, detailsPromise: Awaitable[PaymentDetailsUpdate] | None = None
    ) -> Awaitable[PaymentResponse]: ...
...
class PaymentResponse(EventTarget):
    ...
    def complete(
        self,
        result: PaymentComplete | None = "unknown",
        details: PaymentCompleteDetails | None = {},
    ) -> Awaitable[None]: ...
    def retry(
        self, errorFields: PaymentValidationErrors | None = {}
    ) -> Awaitable[None]: ...
...
class PaymentMethodChangeEvent(PaymentRequestUpdateEvent):
    @classmethod
    def new(
        self, type: str, eventInitDict: PaymentMethodChangeEventInit | None = {}
...
class PaymentRequestUpdateEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: PaymentRequestUpdateEventInit | None = {}
...
class PeriodicSyncManager:
    def register(
        self, tag: str, options: BackgroundSyncOptions | None = {}
    ) -> Awaitable[None]: ...
    def getTags(self) -> Awaitable[Sequence[str]]: ...
...
class PictureInPictureEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: PictureInPictureEventInit
...
class PointerEvent(MouseEvent):
    @classmethod
    def new(
        self, type: str, eventInitDict: PointerEventInit | None = {}
    ) -> PointerEvent: ...
    pointerId: int
    width: float
    height: float
...
class HTMLPortalElement(HTMLElement):
    ...
    referrerPolicy: str
    def activate(
        self, options: PortalActivateOptions | None = {}
    ) -> Awaitable[None]: ...
    def postMessage(
        self, message: Any, options: StructuredSerializeOptions | None = {}
    ): ...
...
class PortalActivateEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: PortalActivateEventInit | None = {}
    ) -> PortalActivateEvent: ...
    data: Any
...
class PresentationRequest(EventTarget):
    ...
    def reconnect(
        self, presentationId: USVString
    ) -> Awaitable[PresentationConnection]: ...
...
class PresentationConnectionAvailableEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: PresentationConnectionAvailableEventInit
...
class PresentationConnectionCloseEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: PresentationConnectionCloseEventInit
...
class PushManager:
    def subscribe(
        self, options: PushSubscriptionOptionsInit | None = {}
    ) -> Awaitable[PushSubscription]: ...
...
class PushSubscriptionChangeEvent(ExtendableEvent):
    @classmethod
    def new(
        self, type: str, eventInitDict: PushSubscriptionChangeEventInit | None = {}
...
class XRWebGLBinding:
    @classmethod
    def new(
        self, session: XRSession, context: XRWebGLRenderingContext
    ) -> XRWebGLBinding: ...
    ...
    def createProjectionLayer(
        self, init: XRProjectionLayerInit | None = {}
    ) -> XRProjectionLayer: ...
    def createQuadLayer(self, init: XRQuadLayerInit | None = {}) -> XRQuadLayer: ...
    def createCylinderLayer(
        self, init: XRCylinderLayerInit | None = {}
    ) -> XRCylinderLayer: ...
    def createEquirectLayer(
        self, init: XREquirectLayerInit | None = {}
    ) -> XREquirectLayer: ...
    def createCubeLayer(self, init: XRCubeLayerInit | None = {}) -> XRCubeLayer: ...
    def getSubImage(
        self, layer: XRCompositionLayer, frame: XRFrame, eye: XREye | None = "none"
    ) -> XRWebGLSubImage: ...
    def getViewSubImage(
        self, layer: XRProjectionLayer, view: XRView
    ) -> XRWebGLSubImage: ...

class RemotePlayback(EventTarget):
    def watchAvailability(
        self, callback: RemotePlaybackAvailabilityCallback
    ) -> Awaitable[int]: ...
...
class ReportingObserver:
    ...
    def new(
        ...
        options: ReportingObserverOptions | None = {},
    ) -> ReportingObserver: ...
    def observe(self): ...
    def disconnect(self): ...
...
class Scheduler:
    def postTask(
        ...
        options: SchedulerPostTaskOptions | None = {},
    ) -> Awaitable[Any]: ...

class TaskPriorityChangeEvent(Event):
    @classmethod
    def new(
        self, type: str, priorityChangeEventInitDict: TaskPriorityChangeEventInit
...
class WakeLock:
    def request(
        self, type: WakeLockType | None = "screen"
    ) -> Awaitable[WakeLockSentinel]: ...
...
class AnimationTimeline:
    def getCurrentTime(
        self, rangeName: CSSOMString | None = None
...
class Selection:
    ...
    def setBaseAndExtent(
        self, anchorNode: Node, anchorOffset: int, focusNode: Node, focusOffset: int
    ): ...
    ...
    def containsNode(
        self, node: Node, allowPartialContainment: bool | None = false
    ) -> bool: ...
...
class Serial(EventTarget):
    ...
    def requestPort(
        self, options: SerialPortRequestOptions | None = {}
...
class SerialPort(EventTarget):
    ...
    def setSignals(
        self, signals: SerialOutputSignals | None = {}
    ) -> Awaitable[None]: ...
...
class ServiceWorkerContainer(EventTarget):
    ...
    def register(
        self, scriptURL: USVString, options: RegistrationOptions | None = {}
    ) -> Awaitable[ServiceWorkerRegistration]: ...
    def getRegistration(
        self, clientURL: USVString | None = ""
    ) -> Awaitable[ServiceWorkerRegistration | None]: ...
...
class Clients:
    ...
    def matchAll(
        self, options: ClientQueryOptions | None = {}
    ) -> Awaitable[Sequence[Client]]: ...
    def openWindow(self, url: USVString) -> Awaitable[WindowClient | None]: ...
...
class ExtendableEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: ExtendableEventInit | None = {}
    ) -> ExtendableEvent: ...
...
class ExtendableMessageEvent(ExtendableEvent):
    @classmethod
    def new(
        self, type: str, eventInitDict: ExtendableMessageEventInit | None = {}
...
class CacheStorage:
    def match(
        self, request: RequestInfo, options: MultiCacheQueryOptions | None = {}
    ) -> Awaitable[Response | None]: ...
...
class FaceDetector:
    @classmethod
    def new(
        self, faceDetectorOptions: FaceDetectorOptions | None = {}
    ) -> FaceDetector: ...
...
class BarcodeDetector:
    @classmethod
    def new(
        self, barcodeDetectorOptions: BarcodeDetectorOptions | None = {}
    ) -> BarcodeDetector: ...
    def detect(
        self, image: ImageBitmapSource
    ) -> Awaitable[Sequence[DetectedBarcode]]: ...
...
class SpeechRecognitionErrorEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: SpeechRecognitionErrorEventInit
...
class SpeechRecognitionEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: SpeechRecognitionEventInit
...
class SpeechSynthesisEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: SpeechSynthesisEventInit
...
class SpeechSynthesisErrorEvent(SpeechSynthesisEvent):
    @classmethod
    def new(
        self, type: str, eventInitDict: SpeechSynthesisErrorEventInit
...
class ReadableStream:
    ...
    def new(
        self,
        underlyingSource: object | None = None,
        strategy: QueuingStrategy | None = {},
    ) -> ReadableStream: ...
    locked: bool
    def cancel(self, reason: Any | None = None) -> Awaitable[None]: ...
    def getReader(
        self, options: ReadableStreamGetReaderOptions | None = {}
    ) -> ReadableStreamReader: ...
    def pipeThrough(
        self, transform: ReadableWritablePair, options: StreamPipeOptions | None = {}
    ) -> ReadableStream: ...
    def pipeTo(
        self, destination: WritableStream, options: StreamPipeOptions | None = {}
    ) -> Awaitable[None]: ...
...
class WritableStream:
    ...
    def new(
        self,
        underlyingSink: object | None = None,
        strategy: QueuingStrategy | None = {},
    ) -> WritableStream: ...
    locked: bool
...
class TransformStream:
    ...
    def new(
        ...
        writableStrategy: QueuingStrategy | None = {},
        readableStrategy: QueuingStrategy | None = {},
    ) -> TransformStream: ...
    readable: ReadableStream
    writable: WritableStream
...
class TouchEvent(UIEvent):
    @classmethod
    def new(
        self, type: str, eventInitDict: TouchEventInit | None = {}
    ) -> TouchEvent: ...
    touches: TouchList
...
class TrustedTypePolicyFactory:
    def createPolicy(
        self, policyName: str, policyOptions: TrustedTypePolicyOptions | None = {}
    ) -> TrustedTypePolicy: ...
    ...
    def getPropertyType(
        self, tagName: str, property: str, elementNs: str | None = ""
    ) -> str | None: ...
...
class FocusEvent(UIEvent):
    @classmethod
    def new(
        self, type: str, eventInitDict: FocusEventInit | None = {}
    ) -> FocusEvent: ...
    relatedTarget: EventTarget | None
...
class WheelEvent(MouseEvent):
    @classmethod
    def new(
        self, type: str, eventInitDict: WheelEventInit | None = {}
    ) -> WheelEvent: ...
...
class KeyboardEvent(UIEvent):
    @classmethod
    def new(
        self, type: str, eventInitDict: KeyboardEventInit | None = {}
    ) -> KeyboardEvent: ...
    ...
    def initKeyboardEvent(
        ...
        viewArg: Window | None = None,
        keyArg: str | None = "",
        locationArg: int | None = 0,
        ctrlKey: bool | None = false,
        altKey: bool | None = false,
        shiftKey: bool | None = false,
...
class CompositionEvent(UIEvent):
    @classmethod
    def new(
        self, type: str, eventInitDict: CompositionEventInit | None = {}
    ) -> CompositionEvent: ...
    data: str
...
class MutationEvent(Event):
    ...
    def initMutationEvent(
        ...
        bubblesArg: bool | None = false,
        cancelableArg: bool | None = false,
        relatedNodeArg: Node | None = None,
        prevValueArg: str | None = "",
        newValueArg: str | None = "",
        attrNameArg: str | None = "",
        attrChangeArg: int | None = 0,
    ): ...

class URLSearchParams:
    @classmethod
    def new(
        self, init: Sequence[Sequence[USVString]] | USVString | USVString | None = ""
    ) -> URLSearchParams: ...
...
class URLPattern:
    ...
    def new(
        ...
        baseURL: USVString,
        options: URLPatternOptions | None = {},
    ) -> URLPattern: ...
    @overload
    @classmethod
    def new(
        self, input: URLPatternInput | None = {}, options: URLPatternOptions | None = {}
    ) -> URLPattern: ...
    def test(
        self, input: URLPatternInput | None = {}, baseURL: USVString | None = None
    ) -> bool: ...
    def exec(
        self, input: URLPatternInput | None = {}, baseURL: USVString | None = None
...
class WebassemblyNamespace:
    ...
    @overload
    def instantiate(
        self, bytes: BufferSource, importObject: object | None = None
    ) -> Awaitable[WebAssemblyInstantiatedSource]: ...
    @overload
    def instantiate(
        self, moduleObject: Module, importObject: object | None = None
    ) -> Awaitable[Instance]: ...
    def compileStreaming(self, source: Awaitable[Response]) -> Awaitable[Module]: ...
    def instantiateStreaming(
        self, source: Awaitable[Response], importObject: object | None = None
    ) -> Awaitable[WebAssemblyInstantiatedSource]: ...
...
class GroupEffect:
    ...
    def new(
        self,
        children: Sequence[AnimationEffect],
        timing: float | EffectTiming | None = {},
    ) -> GroupEffect: ...
...
class KeyframeEffect(AnimationEffect):
    ...
    def new(
        ...
        options: float | KeyframeEffectOptions | None = {},
    ) -> KeyframeEffect: ...
    @overload
    @classmethod
...
class AnimationPlaybackEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: AnimationPlaybackEventInit | None = {}
...
class BasePropertyIndexedKeyframe(TypedDict):
    ...
    composite: NotRequired[
        CompositeOperationOrAuto | Sequence[CompositeOperationOrAuto]
    ]
...
class Animatable:
    def animate(
        self,
        keyframes: object | None,
        options: float | KeyframeAnimationOptions | None = {},
    ) -> Animation: ...
    def getAnimations(
        self, options: GetAnimationsOptions | None = {}
    ) -> Sequence[Animation]: ...
...
class Bluetooth(
    ...
    def requestDevice(
        self, options: RequestDeviceOptions | None = {}
    ) -> Awaitable[BluetoothDevice]: ...
...
class BluetoothDevice(
    ...
    def watchAdvertisements(
        self, options: WatchAdvertisementsOptions | None = {}
    ) -> Awaitable[None]: ...
...
class BluetoothAdvertisingEvent(Event):
    @classmethod
    def new(
        self, type: str, init: BluetoothAdvertisingEventInit
...
class BluetoothRemoteGATTServer:
    ...
    def disconnect(self): ...
    def getPrimaryService(
        self, service: BluetoothServiceUUID
    ) -> Awaitable[BluetoothRemoteGATTService]: ...
    def getPrimaryServices(
        self, service: BluetoothServiceUUID | None = None
    ) -> Awaitable[Sequence[BluetoothRemoteGATTService]]: ...
...
class BluetoothRemoteGATTService(
    ...
    def getCharacteristic(
        self, characteristic: BluetoothCharacteristicUUID
    ) -> Awaitable[BluetoothRemoteGATTCharacteristic]: ...
    def getCharacteristics(
        self, characteristic: BluetoothCharacteristicUUID | None = None
    ) -> Awaitable[Sequence[BluetoothRemoteGATTCharacteristic]]: ...
    def getIncludedService(
        self, service: BluetoothServiceUUID
    ) -> Awaitable[BluetoothRemoteGATTService]: ...
...
class BluetoothRemoteGATTCharacteristic(EventTarget, CharacteristicEventHandlers):
    ...
    value: DataView
    def getDescriptor(
        self, descriptor: BluetoothDescriptorUUID
    ) -> Awaitable[BluetoothRemoteGATTDescriptor]: ...
    def getDescriptors(
        self, descriptor: BluetoothDescriptorUUID | None = None
    ) -> Awaitable[Sequence[BluetoothRemoteGATTDescriptor]]: ...
...
class LockManager:
    ...
    @overload
    def request(
        self, name: str, options: LockOptions, callback: LockGrantedCallback
    ) -> Awaitable[Any]: ...
...
class NDEFReader(EventTarget):
    ...
    def write(
        self, message: NDEFMessageSource, options: NDEFWriteOptions | None = {}
    ) -> Awaitable[None]: ...
    def makeReadOnly(
        self, options: NDEFMakeReadOnlyOptions | None = {}
    ) -> Awaitable[None]: ...

class NDEFReadingEvent(Event):
    @classmethod
    def new(
        self, type: str, readingEventInitDict: NDEFReadingEventInit
    ) -> NDEFReadingEvent: ...
    serialNumber: str
    message: NDEFMessage
...
class BaseAudioContext(EventTarget):
    ...
    def createBuffer(
        self, numberOfChannels: int, length: int, sampleRate: float
    ) -> AudioBuffer: ...
    def createBufferSource(self) -> AudioBufferSourceNode: ...
    def createChannelMerger(
        self, numberOfInputs: int | None = 6
    ) -> ChannelMergerNode: ...
    def createChannelSplitter(
        self, numberOfOutputs: int | None = 6
    ) -> ChannelSplitterNode: ...
    ...
    def createIIRFilter(
        self, feedforward: Sequence[float], feedback: Sequence[float]
    ) -> IIRFilterNode: ...
    ...
    def createPeriodicWave(
        ...
        real: Sequence[float],
        imag: Sequence[float],
        constraints: PeriodicWaveConstraints | None = {},
    ) -> PeriodicWave: ...
    def createScriptProcessor(
        self,
        bufferSize: int | None = 0,
        numberOfInputChannels: int | None = 2,
        numberOfOutputChannels: int | None = 2,
    ) -> ScriptProcessorNode: ...
    ...
    def decodeAudioData(
        ...
        successCallback: DecodeSuccessCallback | None = None,
        errorCallback: DecodeErrorCallback | None = None,
    ) -> Awaitable[AudioBuffer]: ...
...
class AudioContext(BaseAudioContext):
    ...
    def createMediaElementSource(
        self, mediaElement: HTMLMediaElement
    ) -> MediaElementAudioSourceNode: ...
    def createMediaStreamSource(
        self, mediaStream: MediaStream
    ) -> MediaStreamAudioSourceNode: ...
    def createMediaStreamTrackSource(
        self, mediaStreamTrack: MediaStreamTrack
...
class AudioRenderCapacityEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: AudioRenderCapacityEventInit | None = {}
...
class OfflineAudioContext(BaseAudioContext):
    ...
    @classmethod
    def new(
        self, contextOptions: OfflineAudioContextOptions
    ) -> OfflineAudioContext: ...
    @overload
    @classmethod
    def new(
...
class OfflineAudioCompletionEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: OfflineAudioCompletionEventInit
...
class AudioBuffer:
    ...
    def copyFromChannel(
        ...
        channelNumber: int,
        bufferOffset: int | None = 0,
    ): ...
    def copyToChannel(
        self, source: Float32Array, channelNumber: int, bufferOffset: int | None = 0
    ): ...
...
class AudioNode(EventTarget):
    @overload
    def connect(
        self, destinationNode: AudioNode, output: int | None = 0, input: int | None = 0
    ) -> AudioNode: ...
    @overload
...
class AudioParam:
    ...
    def exponentialRampToValueAtTime(
        self, value: float, endTime: float
    ) -> AudioParam: ...
    def setTargetAtTime(
        self, target: float, startTime: float, timeConstant: float
    ) -> AudioParam: ...
    def setValueCurveAtTime(
        self, values: Sequence[float], startTime: float, duration: float
    ) -> AudioParam: ...
...
class AnalyserNode(AudioNode):
    @classmethod
    def new(
        self, context: BaseAudioContext, options: AnalyserOptions | None = {}
    ) -> AnalyserNode: ...
...
class AudioBufferSourceNode(AudioScheduledSourceNode):
    @classmethod
    def new(
        self, context: BaseAudioContext, options: AudioBufferSourceOptions | None = {}
...
class AudioListener:
    ...
    def setOrientation(
        self, x: float, y: float, z: float, xUp: float, yUp: float, zUp: float
    ): ...

class AudioProcessingEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: AudioProcessingEventInit
...
class BiquadFilterNode(AudioNode):
    @classmethod
    def new(
        self, context: BaseAudioContext, options: BiquadFilterOptions | None = {}
    ) -> BiquadFilterNode: ...
...
class ChannelMergerNode(AudioNode):
    @classmethod
    def new(
        self, context: BaseAudioContext, options: ChannelMergerOptions | None = {}
    ) -> ChannelMergerNode: ...
...
class ChannelSplitterNode(AudioNode):
    @classmethod
    def new(
        self, context: BaseAudioContext, options: ChannelSplitterOptions | None = {}
    ) -> ChannelSplitterNode: ...
...
class ConstantSourceNode(AudioScheduledSourceNode):
    @classmethod
    def new(
        self, context: BaseAudioContext, options: ConstantSourceOptions | None = {}
    ) -> ConstantSourceNode: ...
    offset: AudioParam
...
class ConvolverNode(AudioNode):
    @classmethod
    def new(
        self, context: BaseAudioContext, options: ConvolverOptions | None = {}
    ) -> ConvolverNode: ...
    buffer: AudioBuffer | None
    normalize: bool
...
class DelayNode(AudioNode):
    @classmethod
    def new(
        self, context: BaseAudioContext, options: DelayOptions | None = {}
    ) -> DelayNode: ...
...
class DynamicsCompressorNode(AudioNode):
    @classmethod
    def new(
        self, context: BaseAudioContext, options: DynamicsCompressorOptions | None = {}
...
class GainNode(AudioNode):
    @classmethod
    def new(
        self, context: BaseAudioContext, options: GainOptions | None = {}
    ) -> GainNode: ...
    gain: AudioParam
...
class IIRFilterNode(AudioNode):
    @classmethod
    def new(
        self, context: BaseAudioContext, options: IIRFilterOptions
    ) -> IIRFilterNode: ...
    def getFrequencyResponse(
        self,
        frequencyHz: Float32Array,
...
class MediaElementAudioSourceNode(AudioNode):
    @classmethod
    def new(
        self, context: AudioContext, options: MediaElementAudioSourceOptions
    ) -> MediaElementAudioSourceNode: ...
...
class MediaStreamAudioDestinationNode(AudioNode):
    @classmethod
    def new(
        self, context: AudioContext, options: AudioNodeOptions | None = {}
...
class MediaStreamAudioSourceNode(AudioNode):
    @classmethod
    def new(
        self, context: AudioContext, options: MediaStreamAudioSourceOptions
    ) -> MediaStreamAudioSourceNode: ...
...
class MediaStreamTrackAudioSourceNode(AudioNode):
    @classmethod
    def new(
        self, context: AudioContext, options: MediaStreamTrackAudioSourceOptions
    ) -> MediaStreamTrackAudioSourceNode: ...
...
class OscillatorNode(AudioScheduledSourceNode):
    @classmethod
    def new(
        self, context: BaseAudioContext, options: OscillatorOptions | None = {}
    ) -> OscillatorNode: ...
    type: OscillatorType
    frequency: AudioParam
    detune: AudioParam
...
class PannerNode(AudioNode):
    @classmethod
    def new(
        self, context: BaseAudioContext, options: PannerOptions | None = {}
    ) -> PannerNode: ...
...
class PeriodicWave:
    @classmethod
    def new(
        self, context: BaseAudioContext, options: PeriodicWaveOptions | None = {}
    ) -> PeriodicWave: ...
...
class StereoPannerNode(AudioNode):
    @classmethod
    def new(
        self, context: BaseAudioContext, options: StereoPannerOptions | None = {}
    ) -> StereoPannerNode: ...
    pan: AudioParam
...
class WaveShaperNode(AudioNode):
    @classmethod
    def new(
        self, context: BaseAudioContext, options: WaveShaperOptions | None = {}
    ) -> WaveShaperNode: ...
    curve: Float32Array
...
class AudioWorkletGlobalScope(WorkletGlobalScope):
    def registerProcessor(
        self, name: str, processorCtor: AudioWorkletProcessorConstructor
    ): ...
    currentFrame: int
    currentTime: float
    sampleRate: float
...
class AudioWorkletNode(AudioNode):
    ...
    def new(
        ...
        context: BaseAudioContext,
        name: str,
        options: AudioWorkletNodeOptions | None = {},
    ) -> AudioWorkletNode: ...
...
class VideoEncoder:
    ...
    def encode(
        self, frame: VideoFrame, options: VideoEncoderEncodeOptions | None = {}
    ): ...
    def flush(self) -> Awaitable[None]: ...
    def reset(self): ...
    def close(self): ...
...
class VideoFrame:
    ...
    @classmethod
    def new(
        self, image: CanvasImageSource, init: VideoFrameInit | None = {}
    ) -> VideoFrame: ...
    @overload
    @classmethod
    ...
    def copyTo(
        self, destination: BufferSource, options: VideoFrameCopyToOptions | None = {}
    ) -> Awaitable[Sequence[PlaneLayout]]: ...
...
class ImageDecoder:
    ...
    def decode(
        self, options: ImageDecodeOptions | None = {}
    ) -> Awaitable[ImageDecodeResult]: ...
    def reset(self): ...
    def close(self): ...
...
class WebGLRenderingContextBase:
    ...
    def bindRenderbuffer(
        self, target: GLenum, renderbuffer: WebGLRenderbuffer | None
    ): ...
    def bindTexture(self, target: GLenum, texture: WebGLTexture | None): ...
    def blendColor(
        self, red: GLclampf, green: GLclampf, blue: GLclampf, alpha: GLclampf
    ): ...
    ...
    def blendFuncSeparate(
        self, srcRGB: GLenum, dstRGB: GLenum, srcAlpha: GLenum, dstAlpha: GLenum
    ): ...
    ...
    def colorMask(
        self, red: GLboolean, green: GLboolean, blue: GLboolean, alpha: GLboolean
    ): ...
    ...
    def drawElements(
        self, mode: GLenum, count: GLsizei, type: GLenum, offset: GLintptr
    ): ...
    ...
    def framebufferRenderbuffer(
        ...
        renderbuffer: WebGLRenderbuffer | None,
    ): ...
    ...
    def getActiveAttrib(
        self, program: WebGLProgram, index: GLuint
    ...
    def getShaderPrecisionFormat(
        self, shadertype: GLenum, precisiontype: GLenum
    ...
    def getUniform(
        self, program: WebGLProgram, location: WebGLUniformLocation
    ) -> Any: ...
    def getUniformLocation(
        self, program: WebGLProgram, name: str
    ...
    def renderbufferStorage(
        self, target: GLenum, internalformat: GLenum, width: GLsizei, height: GLsizei
    ): ...
    ...
    def stencilFuncSeparate(
        self, face: GLenum, func: GLenum, ref: GLint, mask: GLuint
    ): ...
    ...
    def stencilOpSeparate(
        self, face: GLenum, fail: GLenum, zfail: GLenum, zpass: GLenum
    ): ...
    ...
    def uniform2f(
        self, location: WebGLUniformLocation | None, x: GLfloat, y: GLfloat
    ): ...
    def uniform3f(
        self, location: WebGLUniformLocation | None, x: GLfloat, y: GLfloat, z: GLfloat
    ): ...
    def uniform4f(
        self,
        location: WebGLUniformLocation | None,
        x: GLfloat,
        y: GLfloat,
        z: GLfloat,
        w: GLfloat,
    ...
    def uniform3i(
        self, location: WebGLUniformLocation | None, x: GLint, y: GLint, z: GLint
    ): ...
    def uniform4i(
        self,
        location: WebGLUniformLocation | None,
...
class WebGLRenderingContext(
    WebGLRenderingContextBase, WebGLRenderingContextOverloads
): ...

class WebGLContextEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInit: WebGLContextEventInit | None = {}
    ) -> WebGLContextEvent: ...
    statusMessage: str
...
class WebGL2RenderingContextBase:
    ...
    def getBufferSubData(
        ...
        dstOffset: GLuint | None = 0,
        length: GLuint | None = 0,
    ): ...
    def blitFramebuffer(
        self,
        srcX0: GLint,
    ...
    def compressedTexImage3D(
        ...
        srcData: ArrayBufferView,
        srcOffset: GLuint | None = 0,
        srcLengthOverride: GLuint | None = 0,
    ): ...
    @overload
    ...
    def uniform2ui(
        self, location: WebGLUniformLocation | None, v0: GLuint, v1: GLuint
    ): ...
    def uniform3ui(
        self, location: WebGLUniformLocation | None, v0: GLuint, v1: GLuint, v2: GLuint
    ): ...
    def uniform4ui(
        self,
        location: WebGLUniformLocation | None,
    ...
    def samplerParameterf(
        self, sampler: WebGLSampler, pname: GLenum, param: GLfloat
    ): ...
    ...
    def clientWaitSync(
        self, sync: WebGLSync, flags: GLbitfield, timeout: GLuint64
    ) -> GLenum: ...
    ...
    def bindTransformFeedback(
        self, target: GLenum, tf: WebGLTransformFeedback | None
    ): ...
    def beginTransformFeedback(self, primitiveMode: GLenum): ...
    def endTransformFeedback(self): ...
    def transformFeedbackVaryings(
        self, program: WebGLProgram, varyings: Sequence[str], bufferMode: GLenum
    ): ...
    def getTransformFeedbackVarying(
        self, program: WebGLProgram, index: GLuint
    ) -> WebGLActiveInfo | None: ...
    def pauseTransformFeedback(self): ...
    def resumeTransformFeedback(self): ...
    def bindBufferBase(
        self, target: GLenum, index: GLuint, buffer: WebGLBuffer | None
    ): ...
    def bindBufferRange(
        self,
        target: GLenum,
        index: GLuint,
        buffer: WebGLBuffer | None,
        offset: GLintptr,
        size: GLsizeiptr,
    ): ...
    def getIndexedParameter(self, target: GLenum, index: GLuint) -> Any: ...
    def getUniformIndices(
        self, program: WebGLProgram, uniformNames: Sequence[str]
    ) -> Sequence[GLuint]: ...
    def getActiveUniforms(
        self, program: WebGLProgram, uniformIndices: Sequence[GLuint], pname: GLenum
    ) -> Any: ...
    def getUniformBlockIndex(
        self, program: WebGLProgram, uniformBlockName: str
    ) -> GLuint: ...
    def getActiveUniformBlockParameter(
        self, program: WebGLProgram, uniformBlockIndex: GLuint, pname: GLenum
    ) -> Any: ...
    def getActiveUniformBlockName(
        self, program: WebGLProgram, uniformBlockIndex: GLuint
    ) -> str | None: ...
    ...
    def isVertexArray(
        self, vertexArray: WebGLVertexArrayObject | None
    ) -> GLboolean: ...
...
class WebGL2RenderingContextOverloads:
    ...
    @overload
    def bufferData(
        self, target: GLenum, srcData: BufferSource | None, usage: GLenum
    ): ...
    @overload
    def bufferSubData(
        self, target: GLenum, dstByteOffset: GLintptr, srcData: BufferSource
    ): ...
    @overload
    def bufferData(
        self,
...
class GPU:
    def requestAdapter(
        self, options: GPURequestAdapterOptions | None = {}
    ) -> Awaitable[GPUAdapter | None]: ...
...
class GPUAdapter:
    ...
    def requestDevice(
        self, descriptor: GPUDeviceDescriptor | None = {}
    ) -> Awaitable[GPUDevice]: ...
    def requestAdapterInfo(
        self, unmaskHints: Sequence[str] | None = []
    ) -> Awaitable[GPUAdapterInfo]: ...
...
class GPUDevice(EventTarget, GPUObjectBase):
    ...
    def createSampler(
        self, descriptor: GPUSamplerDescriptor | None = {}
    ) -> GPUSampler: ...
    def importExternalTexture(
        self, descriptor: GPUExternalTextureDescriptor
    ) -> GPUExternalTexture: ...
    ...
    def createRenderPipeline(
        self, descriptor: GPURenderPipelineDescriptor
    ) -> GPURenderPipeline: ...
    def createComputePipelineAsync(
        self, descriptor: GPUComputePipelineDescriptor
    ) -> Awaitable[GPUComputePipeline]: ...
    def createRenderPipelineAsync(
        self, descriptor: GPURenderPipelineDescriptor
    ) -> Awaitable[GPURenderPipeline]: ...
    def createCommandEncoder(
        self, descriptor: GPUCommandEncoderDescriptor | None = {}
    ) -> GPUCommandEncoder: ...
    def createRenderBundleEncoder(
        self, descriptor: GPURenderBundleEncoderDescriptor
...
class GPUBuffer(GPUObjectBase):
    ...
    def mapAsync(
        ...
        offset: GPUSize64 | None = 0,
        size: GPUSize64 | None = None,
    ) -> Awaitable[None]: ...
    def getMappedRange(
        self, offset: GPUSize64 | None = 0, size: GPUSize64 | None = None
    ) -> ArrayBuffer: ...
    def unmap(self): ...
    def destroy(self): ...
...
class GPUTexture(GPUObjectBase):
    def createView(
        self, descriptor: GPUTextureViewDescriptor | None = {}
    ) -> GPUTextureView: ...
    def destroy(self): ...
...
class GPUCommandEncoder(GPUObjectBase, GPUCommandsMixin, GPUDebugCommandsMixin):
    def beginRenderPass(
        self, descriptor: GPURenderPassDescriptor
    ) -> GPURenderPassEncoder: ...
    def beginComputePass(
        self, descriptor: GPUComputePassDescriptor | None = {}
    ...
    def finish(
        self, descriptor: GPUCommandBufferDescriptor | None = {}
    ) -> GPUCommandBuffer: ...
...
class GPUBindingCommandsMixin:
    ...
    def setBindGroup(
        ...
        dynamicOffsets: Sequence[GPUBufferDynamicOffset] | None = [],
    ): ...
    @overload
    def setBindGroup(
        self,
...
class GPUComputePassEncoder(
    GPUObjectBase, GPUCommandsMixin, GPUDebugCommandsMixin, GPUBindingCommandsMixin
):
    def setPipeline(self, pipeline: GPUComputePipeline): ...
    def dispatchWorkgroups(
        self,
        workgroupCountX: GPUSize32,
        workgroupCountY: GPUSize32 | None = 1,
        workgroupCountZ: GPUSize32 | None = 1,
    ): ...
    def dispatchWorkgroupsIndirect(
        self, indirectBuffer: GPUBuffer, indirectOffset: GPUSize64
    ): ...
    def end(self): ...
...
class GPURenderCommandsMixin:
    ...
    def draw(
        ...
        instanceCount: GPUSize32 | None = 1,
        firstVertex: GPUSize32 | None = 0,
        firstInstance: GPUSize32 | None = 0,
    ): ...
    def drawIndexed(
        self,
        indexCount: GPUSize32,
        instanceCount: GPUSize32 | None = 1,
        firstIndex: GPUSize32 | None = 0,
        baseVertex: GPUSignedOffset32 | None = 0,
        firstInstance: GPUSize32 | None = 0,
    ): ...
...
class GPURenderBundleEncoder(
    ...
    def finish(
        self, descriptor: GPURenderBundleDescriptor | None = {}
    ) -> GPURenderBundle: ...
...
class GPUUncapturedErrorEvent(Event):
    @classmethod
    def new(
        self, type: str, gpuUncapturedErrorEventInitDict: GPUUncapturedErrorEventInit
...
class HID(EventTarget):
    ...
    def requestDevice(
        self, options: HIDDeviceRequestOptions
    ) -> Awaitable[Sequence[HIDDevice]]: ...
...
class HIDDevice(EventTarget):
    ...
    def sendFeatureReport(
        self, reportId: octet, data: BufferSource
    ) -> Awaitable[None]: ...
...
class HIDConnectionEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: HIDConnectionEventInit
    ) -> HIDConnectionEvent: ...
    device: HIDDevice
...
class HIDInputReportEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: HIDInputReportEventInit
    ) -> HIDInputReportEvent: ...
    device: HIDDevice
    reportId: octet
    data: DataView
...
class DOMException:
    @classmethod
    def new(
        self, message: str | None = "", name: str | None = "Error"
    ) -> DOMException: ...
    name: str
    message: str
    code: int
...
class MIDIOutput(MIDIPort):
    def send(
        self, data: Sequence[octet], timestamp: DOMHighResTimeStamp | None = 0
    ): ...
    def clear(self): ...
...
class MIDIMessageEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: MIDIMessageEventInit | None = {}
    ) -> MIDIMessageEvent: ...
    data: Uint8Array
...
class MIDIConnectionEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: MIDIConnectionEventInit | None = {}
    ) -> MIDIConnectionEvent: ...
    port: MIDIPort
...
class ML:
    @overload
    def createContext(
        self, options: MLContextOptions | None = {}
    ) -> Awaitable[MLContext]: ...
    @overload
...
class MLCommandEncoder:
    ...
    def dispatch(
        self, graph: MLGraph, inputs: MLNamedGPUResources, outputs: MLNamedGPUResources
    ): ...
    def finish(
        self, descriptor: GPUCommandBufferDescriptor | None = {}
    ) -> GPUCommandBuffer: ...
...
class MLGraphBuilder:
    ...
    @overload
    def constant(
        self, desc: MLOperandDescriptor, bufferView: MLBufferView
    ) -> MLOperand: ...
    @overload
    def constant(
        self, value: float, type: MLOperandType | None = "float32"
    ) -> MLOperand: ...
    ...
    def batchNormalization(
        ...
        mean: MLOperand,
        variance: MLOperand,
        options: MLBatchNormalizationOptions | None = {},
    ) -> MLOperand: ...
    @overload
    ...
    def conv2d(
        self, input: MLOperand, filter: MLOperand, options: MLConv2dOptions | None = {}
    ) -> MLOperand: ...
    def convTranspose2d(
        self,
        input: MLOperand,
        filter: MLOperand,
        options: MLConvTranspose2dOptions | None = {},
    ) -> MLOperand: ...
    ...
    def gemm(
        self, a: MLOperand, b: MLOperand, options: MLGemmOptions | None = {}
    ) -> MLOperand: ...
    def gru(
        self,
        input: MLOperand,
    ...
    def gruCell(
        ...
        hiddenSize: int,
        options: MLGruCellOptions | None = {},
    ) -> MLOperand: ...
    @overload
    def hardSigmoid(
        self, x: MLOperand, options: MLHardSigmoidOptions | None = {}
    ) -> MLOperand: ...
    @overload
    def hardSigmoid(
        self, options: MLHardSigmoidOptions | None = {}
    ) -> MLActivation: ...
    @overload
    ...
    def instanceNormalization(
        self, input: MLOperand, options: MLInstanceNormalizationOptions | None = {}
    ) -> MLOperand: ...
    @overload
    def leakyRelu(
        self, x: MLOperand, options: MLLeakyReluOptions | None = {}
    ) -> MLOperand: ...
    @overload
    def leakyRelu(self, options: MLLeakyReluOptions | None = {}) -> MLActivation: ...
    @overload
    def linear(
        self, x: MLOperand, options: MLLinearOptions | None = {}
    ) -> MLOperand: ...
    @overload
    ...
    def lstmCell(
        ...
        cellState: MLOperand,
        hiddenSize: int,
        options: MLLstmCellOptions | None = {},
    ) -> Sequence[MLOperand]: ...
    def matmul(self, a: MLOperand, b: MLOperand) -> MLOperand: ...
    def pad(
        self, input: MLOperand, padding: MLOperand, options: MLPadOptions | None = {}
    ) -> MLOperand: ...
    def averagePool2d(
        self, input: MLOperand, options: MLPool2dOptions | None = {}
    ) -> MLOperand: ...
    def l2Pool2d(
        self, input: MLOperand, options: MLPool2dOptions | None = {}
    ) -> MLOperand: ...
    ...
    def reduceL1(
        self, input: MLOperand, options: MLReduceOptions | None = {}
    ) -> MLOperand: ...
    def reduceL2(
        self, input: MLOperand, options: MLReduceOptions | None = {}
    ) -> MLOperand: ...
    ...
    def resample2d(
        self, input: MLOperand, options: MLResample2dOptions | None = {}
    ) -> MLOperand: ...
    def reshape(
        self, input: MLOperand, newShape: Sequence[int | None]
    ) -> MLOperand: ...
    @overload
    ...
    @overload
    def softplus(
        self, x: MLOperand, options: MLSoftplusOptions | None = {}
    ) -> MLOperand: ...
    @overload
    ...
    def split(
        self,
        input: MLOperand,
        splits: int | Sequence[int],
        options: MLSplitOptions | None = {},
    ) -> Sequence[MLOperand]: ...
    def squeeze(
        self, input: MLOperand, options: MLSqueezeOptions | None = {}
    ) -> MLOperand: ...
    @overload
    ...
    def transpose(
        self, input: MLOperand, options: MLTransposeOptions | None = {}
    ) -> MLOperand: ...
...
class RTCRtpSender:
    ...
    def generateKeyFrame(
        self, rids: Sequence[str] | None = None
    ) -> Awaitable[None]: ...
...
class SFrameTransform(GenericTransformStream):
    ...
    def setEncryptionKey(
        self, key: CryptoKey, keyID: CryptoKeyID | None = None
    ) -> Awaitable[None]: ...
    onerror: EventHandler
...
class SFrameTransformErrorEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: SFrameTransformErrorEventInit
...
class RTCRtpScriptTransform:
    ...
    def new(
        ...
        worker: Worker,
        options: Any | None = None,
        transfer: Sequence[object] | None = None,
...
class RTCIceTransport(EventTarget):
    ...
    def start(
        self,
        remoteParameters: RTCIceParameters | None = {},
        role: RTCIceRole | None = "controlled",
    ): ...
    def stop(self): ...
...
class RTCPeerConnection(EventTarget):
    ...
    def setIdentityProvider(
        self, provider: str, options: RTCIdentityProviderOptions | None = {}
    ): ...
    ...
    @overload
    def createOffer(
        self, options: RTCOfferOptions | None = {}
    ) -> Awaitable[RTCSessionDescriptionInit]: ...
    @overload
    def createAnswer(
        self, options: RTCAnswerOptions | None = {}
    ) -> Awaitable[RTCSessionDescriptionInit]: ...
    @overload
    def setLocalDescription(
        self, description: RTCLocalSessionDescriptionInit | None = {}
    ) -> Awaitable[None]: ...
    ...
    def setRemoteDescription(
        self, description: RTCSessionDescriptionInit
    ) -> Awaitable[None]: ...
    ...
    @overload
    def addIceCandidate(
        self, candidate: RTCIceCandidateInit | None = {}
    ) -> Awaitable[None]: ...
    ...
    def addTrack(
        self, track: MediaStreamTrack, *streams: MediaStream
    ) -> RTCRtpSender: ...
    def removeTrack(self, sender: RTCRtpSender): ...
    def addTransceiver(
        self,
        trackOrKind: MediaStreamTrack | str,
        init: RTCRtpTransceiverInit | None = {},
    ) -> RTCRtpTransceiver: ...
    ontrack: EventHandler
    sctp: RTCSctpTransport | None
    def createDataChannel(
        self, label: USVString, dataChannelDict: RTCDataChannelInit | None = {}
    ) -> RTCDataChannel: ...
    ondatachannel: EventHandler
    def getStats(
        self, selector: MediaStreamTrack | None = None
    ) -> Awaitable[RTCStatsReport]: ...
...
class RTCSessionDescription:
    @classmethod
    def new(
        self, descriptionInitDict: RTCSessionDescriptionInit
...
class RTCIceCandidate:
    @classmethod
    def new(
        self, candidateInitDict: RTCIceCandidateInit | None = {}
    ) -> RTCIceCandidate: ...
    candidate: str
    sdpMid: str | None
...
class RTCPeerConnectionIceEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: RTCPeerConnectionIceEventInit | None = {}
...
class RTCPeerConnectionIceErrorEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: RTCPeerConnectionIceErrorEventInit
...
class RTCDataChannelEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: RTCDataChannelEventInit
    ) -> RTCDataChannelEvent: ...
...
class RTCDTMFSender(EventTarget):
    def insertDTMF(
        self, tones: str, duration: int | None = 100, interToneGap: int | None = 70
    ): ...
...
class RTCDTMFToneChangeEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: RTCDTMFToneChangeEventInit | None = {}
...
class WebSocket(EventTarget):
    @classmethod
    def new(
        self, url: USVString, protocols: str | Sequence[str] | None = []
    ) -> WebSocket: ...
    url: USVString
    CONNECTING = 0
    OPEN = 1
...
class CloseEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: CloseEventInit | None = {}
    ) -> CloseEvent: ...
    wasClean: bool
    code: int
    reason: USVString
...
class WebTransport:
    @classmethod
    def new(
        self, url: USVString, options: WebTransportOptions | None = {}
    ) -> WebTransport: ...
    ...
    def createBidirectionalStream(
        self, options: WebTransportSendStreamOptions | None = {}
    ) -> Awaitable[WebTransportBidirectionalStream]: ...
    incomingBidirectionalStreams: ReadableStream
    def createUnidirectionalStream(
        self, options: WebTransportSendStreamOptions | None = {}
    ) -> Awaitable[WebTransportSendStream]: ...
...
class USB(EventTarget):
    ...
    def requestDevice(
        self, options: USBDeviceRequestOptions
    ) -> Awaitable[USBDevice]: ...
...
class USBConnectionEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: USBConnectionEventInit
    ) -> USBConnectionEvent: ...
    device: USBDevice
...
class USBInTransferResult:
    @classmethod
    def new(
        self, status: USBTransferStatus, data: DataView | None = None
    ) -> USBInTransferResult: ...
    data: DataView
...
class USBOutTransferResult:
    @classmethod
    def new(
        self, status: USBTransferStatus, bytesWritten: int | None = 0
...
class USBIsochronousOutTransferResult:
    @classmethod
    def new(
        self, packets: Sequence[USBIsochronousOutTransferPacket]
...
class USBDevice:
    ...
    def selectAlternateInterface(
        self, interfaceNumber: octet, alternateSetting: octet
    ) -> Awaitable[None]: ...
    def controlTransferIn(
        self, setup: USBControlTransferParameters, length: int
    ) -> Awaitable[USBInTransferResult]: ...
    def controlTransferOut(
        self, setup: USBControlTransferParameters, data: BufferSource | None = None
    ) -> Awaitable[USBOutTransferResult]: ...
    def clearHalt(
        self, direction: USBDirection, endpointNumber: octet
    ) -> Awaitable[None]: ...
    def transferIn(
        self, endpointNumber: octet, length: int
    ) -> Awaitable[USBInTransferResult]: ...
    def transferOut(
        self, endpointNumber: octet, data: BufferSource
    ) -> Awaitable[USBOutTransferResult]: ...
    def isochronousTransferIn(
        self, endpointNumber: octet, packetLengths: Sequence[int]
    ) -> Awaitable[USBIsochronousInTransferResult]: ...
    def isochronousTransferOut(
        self, endpointNumber: octet, data: BufferSource, packetLengths: Sequence[int]
    ) -> Awaitable[USBIsochronousOutTransferResult]: ...
...
class USBInterface:
    @classmethod
    def new(
        self, configuration: USBConfiguration, interfaceNumber: octet
    ) -> USBInterface: ...
...
class USBAlternateInterface:
    @classmethod
    def new(
        self, deviceInterface: USBInterface, alternateSetting: octet
...
class XRRay:
    ...
    def new(
        self,
        origin: DOMPointInit | None = {},
        direction: XRRayDirectionInit | None = {},
    ) -> XRRay: ...
    @overload
    @classmethod
...
class XRSystem(EventTarget):
    ...
    def requestSession(
        self, mode: XRSessionMode, options: XRSessionInit | None = {}
    ) -> Awaitable[XRSession]: ...
    ondevicechange: EventHandler
...
class XRReferenceSpace(XRSpace):
    def getOffsetReferenceSpace(
        self, originOffset: XRRigidTransform
    ) -> XRReferenceSpace: ...
    onreset: EventHandler
...
class XRRigidTransform:
    @classmethod
    def new(
        self, position: DOMPointInit | None = {}, orientation: DOMPointInit | None = {}
    ) -> XRRigidTransform: ...
...
class XRWebGLLayer(XRLayer):
    ...
    def new(
        ...
        layerInit: XRWebGLLayerInit | None = {},
    ) -> XRWebGLLayer: ...
    antialias: bool
...
class XRInputSourceEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: XRInputSourceEventInit
    ) -> XRInputSourceEvent: ...
    frame: XRFrame
    inputSource: XRInputSource
...
class XRInputSourcesChangeEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: XRInputSourcesChangeEventInit
...
class XRReferenceSpaceEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: XRReferenceSpaceEventInit
...
class XRMediaBinding:
    ...
    def createQuadLayer(
        self, video: HTMLVideoElement, init: XRMediaQuadLayerInit | None = {}
    ) -> XRQuadLayer: ...
    def createCylinderLayer(
        self, video: HTMLVideoElement, init: XRMediaCylinderLayerInit | None = {}
    ) -> XRCylinderLayer: ...
    def createEquirectLayer(
        self, video: HTMLVideoElement, init: XRMediaEquirectLayerInit | None = {}
    ) -> XREquirectLayer: ...
...
class WindowControlsOverlayGeometryChangeEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: WindowControlsOverlayGeometryChangeEventInit
...
class FormData:
    ...
    @overload
    def append(
        self, name: USVString, blobValue: Blob, filename: USVString | None = None
    ): ...
    def delete(self, name: USVString): ...
...
class ProgressEvent(Event):
    @classmethod
    def new(
        self, type: str, eventInitDict: ProgressEventInit | None = {}
    ) -> ProgressEvent: ...
